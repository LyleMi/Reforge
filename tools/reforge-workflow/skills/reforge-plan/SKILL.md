---
name: reforge-plan
description: Optional guard workflow that builds an artifact v6 plan from selected schema 27 Reforge Issues without editing source.
---
...
4. Produce one complete `plan.json` containing artifact schema 6, the exact goal, selected Issue
