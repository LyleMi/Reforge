...
grep -q 'schema 24' "$test_root/skills/reforge-scan/SKILL.md"
grep -q 'schema 24' "$test_root/skills/reforge-plan/SKILL.md"
grep -q 'schema-v3 InvestigationArtifact' "$test_root/agents/reforge-investigator.toml"
if grep -Eqi 'schema 23 issue|schema-v2 InvestigationArtifact' "$test_root/skills/reforge-scan/SKILL.md" "$test_root/skills/reforge-plan/SKILL.md" "$test_root/agents/reforge-investigator.toml"; then
...
grep -q 'schema 24' "$test_root/all-project/.agents/skills/reforge-scan/SKILL.md"
