...
JSON and YAML reports use schema version `6`. The same Rust data model is
...
- `schema_version`: report schema version. Current value is `6`.
...
version `6` does not emit the legacy v4 fields `score`, `score_breakdown`, or
