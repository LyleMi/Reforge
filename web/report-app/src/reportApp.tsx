...
export function App() {
  ...
  return <main>
    <header>
      <div><span className="eyebrow">Schema 23 evidence report</span><h1>Refactoring evidence</h1><p>Deterministic observations, coverage receipts, provenance, and repository context. No inferred ranking or quality score.</p></div>
