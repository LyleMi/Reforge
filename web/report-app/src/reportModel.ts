...
export const REPORT_SCHEMA_VERSION = 22;
...
export function validateReport(value: unknown): ScanReport {
  ...
  if (report.schema_version !== REPORT_SCHEMA_VERSION) throw new Error(`Unsupported Reforge report schema ${String(report.schema_version ?? "missing")}; this report app requires schema 22.`);
